...
class AreaResultsCategory extends StatefulWidget {
  ...
  @override
  _AreaResultsCategoryState createState() => _AreaResultsCategoryState(title: title1);
}
...
class _AreaResultsCategoryState extends State<AreaResultsCategory> {
  ...
  String image = 'https://image.freepik.com/free-vector/cute-chef-girl-smiling-uniform-welcoming-inviting-his-guests-cartoon-art-illustration_56104-578.jpg';

  void getAreaResults() async {
    http.Response response = await http.get(Uri.parse('https://www.themealdb.com/api/json/v1/1/filter.php?a=' + title));
                    ...
                    return RecipeCard(
                      ...
                      ontappy: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Recipe_Instruction_Card2(idNumber: idMeal[index]),
                          ),
                        );
                      },
                    );
